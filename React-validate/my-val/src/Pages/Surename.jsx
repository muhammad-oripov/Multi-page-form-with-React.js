...
function Name() {
    ...
    let { setSurename, } = useContext(AuthContext)
    ...
    return (
        <div className='flex items-center justify-center flex-col'>
            <h1 className=' text-white text-4xl p-12'>Enter your Surname pls</h1>
            <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
                ...
                <Link to='/password'><button class=" ml-6 inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">Next</button></Link>
                </form>
            </div>
        </div>
    )
